data_processing: Process the data in the dataset to prepare for the feature matrix $Z$ introduced in the original paper and the target vector $y$ of the stock risk premium.
